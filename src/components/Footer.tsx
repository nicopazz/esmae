...
export default function Footer() {
  return (
    // CAMBIO 1: Reduje el padding vertical en móvil (pt-8 pb-6) y dejé el grande para escritorio (md:pt-16 md:pb-10)
    <footer className="bg-white text-gray-900 pt-8 pb-6 md:pt-16 md:pb-10 border-t border-gray-100">
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        
        {/* --- GRID PRINCIPAL --- */}
        {/* CAMBIO 2: Reduje el gap (gap-8) y el margen inferior (mb-8 pb-8) en móvil */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 mb-8 md:mb-12 border-b border-gray-100 pb-8 md:pb-12 text-center md:text-left">
          ...
          {/* COLUMNA 1: LOGO */}
          {/* CAMBIO 3: 'hidden' oculta el logo por defecto (móvil). 'md:flex' lo muestra en PC. */}
          ...
          {/* COLUMNA 2: CONTACTO */}
          <div>
            {/* CAMBIO 4: Reduje el margen del título (mb-3 en vez de mb-6) para móvil */}
            <h3 className="text-xs font-bold uppercase tracking-widest mb-3 md:mb-6 text-gray-400">Contacto</h3>
            {/* CAMBIO 5: Reduje el espacio entre items (space-y-2) para móvil */}
