...
import { ShoppingBag, User, LayoutDashboard, Menu, X, ChevronRight, LogOut } from "lucide-react";
  ...
  const handleLogout = () => {
    toast((t) => (
      <div className="flex flex-col gap-3 min-w-50">
        <span className="font-semibold text-sm text-center">¿Quieres cerrar sesión?</span>
